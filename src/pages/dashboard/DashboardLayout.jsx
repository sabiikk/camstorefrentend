  ...
  return (
    ...
    <aside className="hidden sm:flex sm:flex-col">
      <a href="/" className="inline-flex items-center justify-center h-20 w-20 bg-purple-600 hover:bg-purple-500 focus:bg-purple-500">
        <img src="https://img.freepik.com/free-psd/camera-outline-logo-design_23-2151263975.jpg?t=st=1730817611~exp=1730821211~hmac=5c673e175569016c55b1e765ace480d5edc3758788f78ded816c155772bc7a90&w=740" alt="" />
      </a>
        ...
        <div className="flex flex-shrink-0 items-center ml-auto">
          <button className="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
            ...
            <div className="hidden md:flex md:flex-col md:items-end md:leading-tight">
              <span className="font-semibold">ADRIAN LUNA</span>
              <span className="text-sm text-gray-600">ADMIN</span>
            </div>
            <span className="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
              <img src="https://img.freepik.com/free-photo/man-portrait-with-blue-lights-visual-effects_23-2149419476.jpg?t=st=1730817281~exp=1730820881~hmac=f4c8276bb1fd361f1a9377b5fad50b22d8c6d3e25ba504adad26c222a34744e2&w=360" alt="user profile photo" className="h-full w-full object-cover"/>
            </span>
